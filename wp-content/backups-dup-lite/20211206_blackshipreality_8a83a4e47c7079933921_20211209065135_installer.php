...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211206_blackshipreality_8a83a4e47c7079933921_20211209065135_archive.zip';
	const ARCHIVE_SIZE		 = '484085044';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8a83a4e-09065135';
    const SECONDARY_PACKAGE_HASH = '5febf43-09065135';
	const VERSION			 = '1.4.3';
