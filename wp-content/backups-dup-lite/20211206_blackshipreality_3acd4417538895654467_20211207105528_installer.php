...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211206_blackshipreality_3acd4417538895654467_20211207105528_archive.zip';
	const ARCHIVE_SIZE		 = '454565668';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3acd441-07105528';
    const SECONDARY_PACKAGE_HASH = 'd72705c-07105528';
	const VERSION			 = '1.4.3';
