...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211206_blackshipreality_7118ef2cc8a8b9d55230_20211208090744_archive.zip';
	const ARCHIVE_SIZE		 = '482371505';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7118ef2-08090744';
    const SECONDARY_PACKAGE_HASH = '1c2588a-08090744';
	const VERSION			 = '1.4.3';
